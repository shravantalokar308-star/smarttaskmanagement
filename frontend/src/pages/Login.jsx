...
import { Layers, ArrowRight, Mail, Lock, ShieldAlert } from 'lucide-react';
      ...
      <div className="w-full max-w-md transform rounded-2xl glass-panel bg-[#13172C]/60 p-8 shadow-2xl transition-all duration-300 border border-slate-800/80 z-10">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h2 className="font-heading text-2xl font-bold tracking-tight text-white">
            Welcome Back to <span className="bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent font-semibold">Synapse</span>
          </h2>
          <p className="text-xs text-slate-400 mt-1">
            Access your collaborative team workspace
          </p>
        </div>
        ...
        {/* Google Sign-In Button — FIRST, like real websites */}
        <div className="mb-6">
          <button
            type="button"
            disabled={loading}
        ...
        <div className="mt-8 text-center border-t border-slate-800/40 pt-5">
          <p className="text-xs text-slate-400">
            Don't have an account on Synapse?{' '}
            <Link 
              to="/register" 
